...
export default function RemovePages() {
  ...
  const handleRemove = async () => {
    ...
    await processFiles(files, 'remove', { pageNumbers });
    setFiles([]);
    setPageRange("");
  };
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4" data-testid="page-title">Remove PDF Pages</h1>
        ...
        {files.length > 0 && (
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Specify which pages to remove from the PDF</CardDescription>
            </CardHeader>
            <CardContent>
