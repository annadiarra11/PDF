...
import { FileText, Wrench, Upload, X } from "lucide-react";
...
export default function RepairPdf() {
  ...
  const handleRepair = async () => {
    await processFiles(files, 'repair', {});
    setFiles([]);
  };
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4" data-testid="page-title">Repair PDF</h1>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Select a PDF file that may be corrupted or damaged to attempt repair.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div
