...
export default function ProtectPdf() {
  ...
  const handleProtect = async () => {
    ...
    await processFiles(files, 'protect', { password });
    setFiles([]);
    setPassword("");
    setConfirmPassword("");
  };
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4" data-testid="page-title">Protect PDF</h1>
        ...
        {files.length > 0 && (
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Set a password to protect your PDF document</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        {files.length > 0 && password && confirmPassword && (
